...
type NetworkConfigurationStatus struct {
	...
	// conditions represent the current state of the NetworkConfiguration resource.
...
type NetworkConfiguration struct {
	...
	// spec defines the desired state of NetworkConfiguration
	// +required
	Spec NetworkConfigurationSpec `json:"spec"`

	// status defines the observed state of NetworkConfiguration
	// +optional
	Status NetworkConfigurationStatus `json:"status,omitempty,omitzero"`
}
